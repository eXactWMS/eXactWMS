...
//Banco de Dados
  ...
  Try
    ...
    if ArqIni.ReadString('msService', 'cripto', '1') = '1' then Begin
    ...
    End
    Else Begin
       RESTClientWMS.BaseURL := 'http://'+ArqIni.ReadString('msService', 'IpMain','127.0.0.1:8200');
       ClientReport.BaseURL  := 'http://'+ArqIni.ReadString('msService', 'IpReport','127.0.0.1:8200');
       ClientGraphics.BaseURL := 'http://'+ArqIni.ReadString('msService', 'IpMain','127.0.0.1:8200');
    End;
    EtqCodBarra_Modelo := ArqIni.ReadString('Printer', 'EtqCodBarra_Modelo', '');
    EtqCodBarra_Porta  := ArqIni.ReadString('Printer', 'EtqCodBarra_Porta', '');
