inherited FrmCargaMontar: TFrmCargaMontar
  ...
  inherited PgcBase: TcxPageControl
    ...
    object TabCargaAnaliseCubagem: TcxTabSheet
      CustomHint = BalloonHint1
      Caption = 'An'#225'lise de Cubagem'
      ImageIndex = 5
      OnShow = TabCargaAnaliseCubagemShow
      ...
      object LblCubagemTotalAC: TLabel
        Left = 593
        Top = 144
        Width = 116
        Height = 17
      ...
      object EdtCargaIdAC: TJvCalcEdit
        ...
        OnKeyPress = EdtCargaIdACKeyPress
      end
      ...
      object LstCargaAnaliseCubagem: TAdvStringGrid
        Left = 0
        Top = 164
        Width = 1279
        Height = 447
        ...
        HoverRowColor = 15658717
        HoverRowCells = [hcNormal, hcSelected]
        OnClickCell = LstCargaAnaliseCubagemClickCell
        HintColor = 5080903
        ActiveCellShow = True
        ActiveCellFont.Charset = DEFAULT_CHARSET
        ActiveCellFont.Color = clWindowText
  ...
  object FdMemCargaAnaliseCubagem: TFDMemTable
    FetchOptions.AssignedValues = [evMode]
    FetchOptions.Mode = fmAll
    ResourceOptions.AssignedValues = [rvSilentMode]
    ResourceOptions.SilentMode = True
