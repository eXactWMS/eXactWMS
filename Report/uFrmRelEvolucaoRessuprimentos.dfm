inherited FrmRelEvolucaoRessuprimentos: TFrmRelEvolucaoRessuprimentos
  ...
  inherited PgcBase: TcxPageControl
    ...
    inherited TabPrincipal: TcxTabSheet
      ...
      object GroupBox1: TGroupBox
        ...
        Height = 50
        CustomHint = BalloonHint1
        Caption = '[ Per'#237'odo Ressuprimento/Pedidos ]'
        TabOrder = 3
        TabStop = True
  ...
  object FdMemEvolucao: TFDMemTable
    FetchOptions.AssignedValues = [evMode]
    FetchOptions.Mode = fmAll
    ResourceOptions.AssignedValues = [rvSilentMode]
    ResourceOptions.SilentMode = True
  ...
  object DataSource1: TDataSource
    DataSet = FdMemEvolucao
    Left = 280
    Top = 466
  end
  object FDMemZona: TFDMemTable
    FieldDefs = <>
    IndexDefs = <>
    FetchOptions.AssignedValues = [evMode]
    FetchOptions.Mode = fmAll
    ...
    Left = 471
    Top = 345
    object FDMemZonaZonaid: TIntegerField
      FieldName = 'Zonaid'
    end
    object FDMemZonaDescricao: TStringField
      FieldName = 'Descricao'
      Size = 30
    end
    object FDMemZonaAtivo: TIntegerField
      FieldName = 'Ativo'
    end
  end
end
