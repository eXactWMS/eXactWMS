...
begin
  THorse.Group.Prefix('v1')
    ...
    .Get('/pedidovolume/volumecomdivergencia/:pedidovolumeid/:enderecoid', GetVolumeComDivergencia)
  ...
  Try
    ...
    Try
      ...
      Tutil.SalvarLog(Req.MethodType, StrToIntDef(Req.Headers['usuarioid'], 0),
        ...
        [rfReplaceAll]), 200, CalculaTempoProcesso(HrInicioLog),
...
begin
  Try
    HrInicioLog := getCurrentTime;
    Tutil.Gravalog('[493 - SalvarColetaComRegistro] executando '+Req.Body);
    Try
      LService := TServicePedidoVolume.Create;
      JsonArrayRetorno := LService.SalvarColetaComRegistro(TJSONObject.ParseJSONValue(TEncoding.ASCII.GetBytes(Req.Body), 0) as TJSONObject);
      Res.Status(200).Send<TJsonArray>(JsonArrayRetorno);
      Try
      Tutil.SalvarLog(Req.MethodType, StrToIntDef(Req.Headers['usuarioid'], 0), Req.Headers['terminal'], ClientIP(Req), THorse.Port,
                      ...
                      200, CalculaTempoProcesso(HrInicioLog), Req.Headers['appname'] + '_V: ' + Req.Headers['versao']);
      Tutil.Gravalog('[494 - SalvarColetaComRegistro] Sucesso na execução '+Req.Body);
      Except ON E: Exception Do Begin
        Tutil.Gravalog('888 - Ocorreu ERRO em MService.PedidoVolumeCtrl.SalvarColetaComRegistro - [SalvarColetaComRegistro] ' + E.Message);
        writeLn('*************************** ERRO FUNCAO SALVAR LOG ********************');
        End;
      End;
    Except On E: Exception do
      Begin
        Tutil.Gravalog('999 - Ocorreu ERRO em MService.PedidoVolumeCtrl.SalvarColetaComRegistro - [SalvarColetaComRegistro] ' + E.Message);
        ...
        Tutil.SalvarLog(Req.MethodType, StrToIntDef(Req.Headers['usuarioid'], 0), Req.Headers['terminal'], ClientIP(Req), THorse.Port,
                        '/v1/pedidovolume/salvarcoletacomregistro', Trim(Req.Params.Content.Text), Req.Body, '', E.Message,
                        500, CalculaTempoProcesso(HrInicioLog), Req.Headers['appname'] + '_V: ' + Req.Headers['versao']);
      End;
    End;
  Finally
    Try
      FreeAndNil(LService);
    Except On E: Exception do Begin
      Tutil.Gravalog('777 - Ocorreu ERRO em MService.PedidoVolumeCtrl.SalvarColetaComRegistro - [SalvarColetaComRegistro] ' + E.Message);
      End;
    End;
  End;
End;
  ...
  Try
    ...
    Except
      ...
      Begin
        ...
        Tutil.SalvarLog(Req.MethodType, StrToIntDef(Req.Headers['usuarioid'],
          0), Req.Headers['terminal'], ClientIP(Req), THorse.Port,
          '/v1/pedidovolume/saveapanheprodutos', Trim(Req.Params.Content.Text), Req.Body, '', E.Message,
...
begin
  Try
    ...
    Except On E: Exception do Begin
        ...
        Res.Status(500).Send<TJsonArray>(JsonArrayErro);
        Tutil.SalvarLog(Req.MethodType, StrToIntDef(Req.Headers['usuarioid'], 0), Req.Headers['terminal'], ClientIP(Req), THorse.Port,
                       '/v1/pedidovolume/etiquetaporrua', Trim(Req.Params.Content.Text), Req.Body, '', E.Message,
                       500, CalculaTempoProcesso(HrInicioLog), Req.Headers['appname'] + '_V: ' + Req.Headers['versao']);
      End;
    End;
  Finally
  ...
  Try
    ...
    Try
      if StrToIntDef(Req.Params.Items['usuarioid'], 0) <= 0 Then
         Raise Exception.Create('Id de usuário inválido!');
  ...
  Try
    ...
    Except on E: Exception do
      Begin
        ...
        Tutil.SalvarLog(Req.MethodType, StrToIntDef(Req.Headers['usuarioid'], 0), Req.Headers['terminal'], ClientIP(Req), THorse.Port,
                        '/v1/pedidovolume/lotesubstituicao', Trim(Req.Params.Content.Text), Req.Body, '',  E.Message,
                        500, CalculaTempoProcesso(HrInicioLog), Req.Headers['appname'] + '_V: ' + Req.Headers['versao']);
      End;
    End;
  Finally
  ...
  Try
    ...
    Except On E: Exception do
      Begin
        ...
        Res.Status(500).Send<TJsonArray>(JsonArrayRetorno);
        Tutil.SalvarLog(Req.MethodType, StrToIntDef(Req.Headers['usuarioid'], 0), Req.Headers['terminal'], ClientIP(Req), THorse.Port,
                        '/v1/etiquetaporvolume/:pedidovolumeid', Trim(Req.Params.Content.Text), Req.Body, '', E.Message,
                        500, CalculaTempoProcesso(HrInicioLog), Req.Headers['appname'] + '_V: ' + Req.Headers['versao']);
      End;
    End;
  Finally
  ...
  Try
    ...
    Except On E: Exception do
      Begin
        ...
        Res.Status(500).Send<TJsonArray>(JsonArrayRetorno);
        Tutil.SalvarLog(Req.MethodType, StrToIntDef(Req.Headers['usuarioid'], 0), Req.Headers['terminal'], ClientIP(Req), THorse.Port,
                        '/v1/identificavolumecxafechada/:pedidovolumeid', Trim(Req.Params.Content.Text), Req.Body, '', E.Message,
                        500, CalculaTempoProcesso(HrInicioLog), Req.Headers['appname'] + '_V: ' + Req.Headers['versao']);
      End;
    End;
  Finally
...
begin
  Try
    ...
    Try
      ...
      Res.Status(200).Send<TJsonArray>(JsonArrayRetorno);
      Tutil.SalvarLog(Req.MethodType, StrToIntDef(Req.Headers['usuarioid'], 0), Req.Headers['terminal'], ClientIP(Req), THorse.Port,
                      '/v1/caixaembalagem/:pedidovolumeid/:caixaembalagemid', Trim(Req.Params.Content.Text), Req.Body, '', StringReplace(JsonArrayRetorno.ToString, #39, '', [rfReplaceAll]),
                      201, CalculaTempoProcesso(HrInicioLog), Req.Headers['appname'] + '_V: ' + Req.Headers['versao']);
    Except on E: Exception do
      Begin
        JsonArrayErro := TJsonArray.Create;
        ...
        Tutil.SalvarLog(Req.MethodType, StrToIntDef(Req.Headers['usuarioid'], 0), Req.Headers['terminal'], ClientIP(Req), THorse.Port,
                        '/v1/caixaembalagem/:pedidovolumeid/:caixaembalagemid', Trim(Req.Params.Content.Text), Req.Body, '', E.Message,
                        500, CalculaTempoProcesso(HrInicioLog), Req.Headers['appname'] + '_V: ' + Req.Headers['versao']);
      End;
    End;
  Finally
  ...
  Try
    ...
    Except on E: Exception do
      Begin
        ...
        Res.Status(500).Send<TJsonArray>(JsonArrayRetorno);
        Tutil.SalvarLog(Req.MethodType, StrToIntDef(Req.Headers['usuarioid'], 0), Req.Headers['terminal'], ClientIP(Req), THorse.Port,
                        '/v1/pedidovolume/lotes/:pedidovolumeid', Trim(Req.Params.Content.Text), Req.Body, '', E.Message,
                        500, CalculaTempoProcesso(HrInicioLog), Req.Headers['appname']+'_V: '+Req.Headers['versao']);
      End;
    End;
  Finally
  ...
  Try
    ...
    Try
      ...
      Tutil.SalvarLog(Req.MethodType, StrToIntDef(Req.Headers['usuarioid'], 0),
        ...
        200, CalculaTempoProcesso(HrInicioLog), Req.Headers['appname'] + '_V: ' +
        Req.Headers['versao']);
    Except
      on E: Exception do
      Begin
        ...
        Tutil.SalvarLog(Req.MethodType, StrToIntDef(Req.Headers['usuarioid'],
          0), Req.Headers['terminal'], ClientIP(Req), THorse.Port,
          '/v1/pedidovolume/producaodiariaporloja', Trim(Req.Params.Content.Text), Req.Body, '', E.Message,
          500, CalculaTempoProcesso(HrInicioLog), Req.Headers['appname'] + '_V: ' + Req.Headers['versao']);
      End;
    End;
  Finally
  ...
  Try
    ...
    Except on E: Exception do
      Begin
        ...
        Res.Status(500).Send<TJsonArray>(JsonArrayRetorno);
        Tutil.SalvarLog(Req.MethodType, StrToIntDef(Req.Headers['usuarioid'], 0), Req.Headers['terminal'], ClientIP(Req), THorse.Port,
                        '/v1/pedidovolume/consulta', Trim(Req.Params.Content.Text), Req.Body, '', E.Message,
                        500, CalculaTempoProcesso(HrInicioLog), Req.Headers['appname']+'_V: '+Req.Headers['versao']);
      End;
    End;
  Finally
  ...
  Try
    ...
    Except on E: Exception do
      Begin
        ...
        Res.Status(500).Send<TJsonArray>(JsonArrayRetorno);
        Tutil.SalvarLog(Req.MethodType, StrToIntDef(Req.Headers['usuarioid'], 0), Req.Headers['terminal'], ClientIP(Req), THorse.Port,
                        '/v1/pedidovolume/excel', Trim(Req.Params.Content.Text), Req.Body, '', E.Message,
                        500, CalculaTempoProcesso(HrInicioLog), Req.Headers['appname']+'_V: '+Req.Headers['versao']);
      End;
    End;
  Finally
  ...
  Try
    ...
    Except on E: Exception do
      Begin
        ...
        Res.Status(500).Send<TJsonArray>(JsonArrayRetorno);
        Tutil.SalvarLog(Req.MethodType, StrToIntDef(Req.Headers['usuarioid'], 0), Req.Headers['terminal'], ClientIP(Req), THorse.Port,
                        '/v1/pedidovolume/consultalotes', Trim(Req.Params.Content.Text), Req.Body, '', E.Message,
                        500, CalculaTempoProcesso(HrInicioLog), Req.Headers['appname']+'_V: '+Req.Headers['versao']);
      End;
    End;
  Finally
  ...
  Try
    ...
    Except on E: Exception do
      Begin
        ...
        Tutil.SalvarLog(Req.MethodType, StrToIntDef(Req.Headers['usuarioid'], 0), Req.Headers['terminal'], ClientIP(Req), THorse.Port,
                        '/v1/pedidovolume/getpedidocxafechadacheckout/:pedidovolumeid', Trim(Req.Params.Content.Text), Req.Body, '', E.Message,
                        200, CalculaTempoProcesso(HrInicioLog), Req.Headers['appname'] + '_V: ' + Req.Headers['versao']);
      End;
    End;
  Finally
  ...
  Try
    ...
    Except
      ...
      Begin
        ...
        Tutil.SalvarLog(Req.MethodType, StrToIntDef(Req.Headers['usuarioid'],
          0), Req.Headers['terminal'], ClientIP(Req), THorse.Port,
          '/v1/pedidovolume/ean/:pedidovolumeid', Trim(Req.Params.Content.Text), Req.Body, '', E.Message,
          500, CalculaTempoProcesso(HrInicioLog), Req.Headers['appname'] + '_V: ' + Req.Headers['versao']);
      End;
    End;
  Finally
  ...
  Try
    ...
    Try
      ...
      If (StrToIntDef(Req.Params.Items['cargaid'], 0) <= 0) then
         Raise Exception.Create('Identificação de carga inválido');
  ...
  Try
    ...
    Except On E: Exception do
      Begin
        ...
        Res.Status(500).Send<TJsonArray>(JsonArrayRetorno);
        Tutil.SalvarLog(Req.MethodType, StrToIntDef(Req.Headers['usuarioid'], 0), Req.Headers['terminal'], ClientIP(Req), THorse.Port,
                        '/v1/pedidovolume/registrardocumentoetapa', Trim(Req.Params.Content.Text), Req.Body, '', E.Message,
                        500, CalculaTempoProcesso(HrInicioLog), Req.Headers['appname']+'_V: '+Req.Headers['versao']);
      End;
    End;
  Finally
        ...
        Begin
          ...
          Begin
            ...
            Tutil.SalvarLog(Req.MethodType,
              ...
              '/v1/pedidovolume/registrardocumentoetapacombaixaestoque',
              Trim(Req.Params.Content.Text), Req.Body, '', E.Message,
              500, CalculaTempoProcesso(HrInicioLog), Req.Headers['appname'] +
    ...
    Try
      Try
        ...
        Tutil.SalvarLog(Req.MethodType, StrToIntDef(Req.Headers['usuarioid'], 0), Req.Headers['terminal'], ClientIP(Req), THorse.Port,
                        ...
                        'Retorno: ' + JsonArrayRetorno.Count.ToString + ' Registros.', 200, CalculaTempoProcesso(HrInicioLog),
                        Req.Headers['appname'] + '_V: ' + Req.Headers['versao']);
        Erro := False;
      Except on E: Exception do
        Begin
  ...
  Try
    ...
    Except
      ...
      Begin
        ...
        Tutil.SalvarLog(Req.MethodType, StrToIntDef(Req.Headers['usuarioid'],
          0), Req.Headers['terminal'], ClientIP(Req), THorse.Port,
          '/v1/pedidovolume/:pedidovolumeid', Trim(Req.Params.Content.Text), Req.Body, '', E.Message,
          500, CalculaTempoProcesso(HrInicioLog), Req.Headers['appname'] + '_V: ' + Req.Headers['versao']);
      End;
    End;
  Finally
  ...
  Try
    ...
    Except on E: Exception do
      Begin
        ...
        Res.Status(500).Send<TJsonArray>(JsonArrayErro);
        Tutil.SalvarLog(Req.MethodType, StrToIntDef(Req.Headers['usuarioid'], 0), Req.Headers['terminal'], ClientIP(Req), THorse.Port,
                        '/v1/pedidovolume/dshvolumeevolucao_quantidade', Trim(Req.Params.Content.Text), Req.Body, '', E.Message,
                        500, CalculaTempoProcesso(HrInicioLog), Req.Headers['appname'] + '_V: ' + Req.Headers['versao']);
      End;
    End;
  Finally
  ...
  Try
    ...
    Try
      If (Req.Params.Items['pedidovolumeid'].ToInteger() <= 0) then
         raise Exception.Create('Id('+Req.Params.Items['pedidovolumeid']+') de Volume inválido!');
      ...
      Tutil.SalvarLog(Req.MethodType, StrToIntDef(Req.Headers['usuarioid'], 0), Req.Headers['terminal'], ClientIP(Req), THorse.Port,
                      ...
                      'Retorno: ' + JsonArrayRetorno.Count.ToString + ' Operação de (Re)CheckOut cancelada.',
                      201, CalculaTempoProcesso(HrInicioLog), Req.Headers['appname'] + '_V: '+Req.Headers['versao']);
    Except on E: Exception do
      Begin
        JsonArrayErro := TJsonArray.Create;
  ...
  Try
    ...
    Except
      ...
      Begin
        ...
        Res.Status(500).Send<TJsonArray>(JsonArrayErro);
        Tutil.SalvarLog(Req.MethodType, StrToIntDef(Req.Headers['usuarioid'], 0), Req.Headers['terminal'], ClientIP(Req), THorse.Port,
                        '/v1/pedidovolume/dshcheckout', Trim(Req.Params.Content.Text), Req.Body, '', E.Message,
                        500, CalculaTempoProcesso(HrInicioLog), Req.Headers['appname'] + '_V: ' + Req.Headers['versao']);
      End;
    End;
  Finally
...
begin
  Try
    ...
    Try
      JsonArrayRetorno := LService.GetVolumeComDivergencia(Req.Params.Items['pedidovolumeid'].ToInteger(), Req.Params.Items['enderecoid'].ToInteger());
      Res.Status(200).Send<TJsonArray>(JsonArrayRetorno);
      Tutil.SalvarLog(Req.MethodType, StrToIntDef(Req.Headers['usuarioid'], 0),
        Req.Headers['terminal'], ClientIP(Req), THorse.Port,
    ...
    Except
      ...
      Begin
        ...
        Tutil.SalvarLog(Req.MethodType, StrToIntDef(Req.Headers['usuarioid'],
          0), Req.Headers['terminal'], ClientIP(Req), THorse.Port,
          '/v1/pedidovolume/volumecomdivergencia/:pedidovolumeid', Trim(Req.Params.Content.Text), Req.Body, '',E.Message,
          500, CalculaTempoProcesso(HrInicioLog), Req.Headers['appname'] + '_V: ' + Req.Headers['versao']);
      End;
    End;
  Finally
