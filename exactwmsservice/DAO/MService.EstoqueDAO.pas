...
begin
  ...
  Except
    On E: Exception do
    Begin
      raise Exception.Create('Processo: Estoque - ' + StringReplace(E.Message,
        '[FireDAC][Phys][ODBC][Microsoft][SQL Server Native Client 11.0][SQL Server]',
        '', [rfReplaceAll]));
    End;
  end;
...
begin
  Try
    FConexao.Query.Sql.Add(TuEvolutConst.SqlEstoqueReservaProduto);
    FConexao.Query.ParamByName('pCodProduto').Value := pCodProduto;
    if DebugHook <> 0 then
       FConexao.Query.Sql.SaveToFile('EstoqueReservaProduto.Sql');
    FConexao.Query.Open;
  ...
  try
    ...
    Else
      ...
      Begin
        ...
        JsonEstoque.AddPair('produtoid', TJsonNumber.Create(FConexao.Query.FieldByName('ProdutoId').AsInteger));
        JsonEstoque.AddPair('codigoerp', TJsonNumber.Create(FConexao.Query.FieldByName('CodigoERP').AsInteger));
        JsonEstoque.AddPair('produto', FConexao.Query.FieldByName('Produto').AsString);
        JsonEstoque.AddPair('unidadeid', TJsonNumber.Create(FConexao.Query.FieldByName('UnidadeId').AsInteger));
        JsonEstoque.AddPair('unidadedecundariaid', TJsonNumber.Create(FConexao.Query.FieldByName('UnidadeSecundariaId').AsInteger));
        JsonEstoque.AddPair('embprim', FConexao.Query.FieldByName('UnidadeDescricao').AsString);
        JsonEstoque.AddPair('embsec', FConexao.Query.FieldByName('UnidadeSecundariaDescricao').AsString);
        JsonEstoque.AddPair('qtdunid', TJsonNumber.Create(FConexao.Query.FieldByName('QtdUnid').AsInteger));
        JsonEstoque.AddPair('fatorconversao', TJsonNumber.Create(FConexao.Query.FieldByName('FatorConversao').AsInteger));
        JsonEstoque.AddPair('messaidaminima', TJsonNumber.Create(FConexao.Query.FieldByName('MesSaidaMinima').AsInteger));
        JsonEstoque.AddPair('loteid', TJsonNumber.Create(FConexao.Query.FieldByName('LoteId').AsInteger));
        JsonEstoque.AddPair('descrlote', FConexao.Query.FieldByName('DescrLote').AsString);
        JsonEstoque.AddPair('fabricacao', DateToStr(FConexao.Query.FieldByName('Fabricacao').AsDateTime));
        JsonEstoque.AddPair('vencimento', DateToStr(FConexao.Query.FieldByName('Vencimento').AsDateTime));
        JsonEstoque.AddPair('enderecoid', TJsonNumber.Create(FConexao.Query.FieldByName('EnderecoId').AsInteger));
        JsonEstoque.AddPair('endereco', FConexao.Query.FieldByName('Endereco').AsString);
        JsonEstoque.AddPair('estruturaid', TJsonNumber.Create(FConexao.Query.FieldByName('EstruturaId').AsInteger));
        JsonEstoque.AddPair('estrutura', FConexao.Query.FieldByName('Estrutura').AsString);
        JsonEstoque.AddPair('pickingfixo', TJsonNumber.Create(FConexao.Query.FieldByName('PickingFixo').AsInteger));
        JsonEstoque.AddPair('status', TJsonNumber.Create(FConexao.Query.FieldByName('Status').AsInteger));
        JsonEstoque.AddPair('zonaid', TJsonNumber.Create(FConexao.Query.FieldByName('ZonaId').AsInteger));
        JsonEstoque.AddPair('zona', FConexao.Query.FieldByName('Zona').AsString);
        JsonEstoque.AddPair('qtdeproducao', TJsonNumber.Create(FConexao.Query.FieldByName('QtdeProducao').AsInteger));
        JsonEstoque.AddPair('qtdereserva', TJsonNumber.Create(FConexao.Query.FieldByName('QtdeReserva').AsInteger));
        JsonEstoque.AddPair('qtde', TJsonNumber.Create(FConexao.Query.FieldByName('Qtde').AsInteger));
        // Saldo Estoque
        JsonEstoque.AddPair('estoquetipoid', TJsonNumber.Create(FConexao.Query.FieldByName('EstoqueTipoId').AsInteger));
        JsonEstoque.AddPair('estoquetipo', FConexao.Query.FieldByName('EstoqueTipo').AsString);
        JsonEstoque.AddPair('producao', TJsonNumber.Create(FConexao.Query.FieldByName('Producao').AsInteger));
        JsonEstoque.AddPair('distribuicao', TJsonNumber.Create(FConexao.Query.FieldByName('Distribuicao').AsInteger));
        JsonEstoque.AddPair('dtentrada', FConexao.Query.FieldByName('DtEntrada').AsString); //DateToStr(FConexao.Query.FieldByName('DtEntrada').AsDateTime));
        if FConexao.Query.FieldByName('hrentrada').AsString = '' then
           JsonEstoque.AddPair('hrentrada', '00:00:00')
        Else
           JsonEstoque.AddPair('hrentrada', TimeToStr(StrToTime(Copy(FConexao.Query.FieldByName('HrEntrada').AsString, 1, 8))));
        if FConexao.Query.FieldByName('horario').AsString = '' then
           JsonEstoque.AddPair('horario', '00:00:00')
        Else
           JsonEstoque.AddPair('horario', Copy(TimeToStr(FConexao.Query.FieldByName('horario').AsDateTime), 1, 8));
        // TimeToStr(StrToTime(Copy(FConexao.Query.FieldByName('horario').AsString,1,8))));
        JsonEstoque.AddPair('usuarioid', TJsonNumber.Create(FConexao.Query.FieldByName('UsuarioId').AsInteger));
        JsonEstoque.AddPair('ordem', TJsonNumber.Create(FConexao.Query.FieldByName('Ordem').AsInteger));
        JsonEstoque.AddPair('mascara', FConexao.Query.FieldByName('Mascara').AsString);
        // Result := FConexao.Query.ToJSONArray();
...
begin
  Try
    ...
    if AParams.ContainsKey('enderecoid') then
       FConexao.Query.ParamByName('pEnderecoDestinoId').Value := StrToIntDef(AParams.Items['enderecoid'], 0)
    Else
       FConexao.Query.ParamByName('pEnderecoDestinoId').Value := 0;
    if AParams.ContainsKey('tipomovimentacao') then
       FConexao.Query.ParamByName('pTipoMovimentacao').Value := StrToIntDef(AParams.Items['tipomovimentacao'], 0)
    Else
       FConexao.Query.ParamByName('pTipoMovimentacao').Value := 1;
    if AParams.ContainsKey('usuarioid') then
       FConexao.Query.ParamByName('pUsuarioId').Value := StrToIntDef(AParams.Items['usuarioid'], 0)
    Else
...
begin
  Try
    FConexao.Query.Sql.Add(TuEvolutConst.SqlGetControleArmazenagemSintetico);
    if AParams.ContainsKey('datainicial') then
       FConexao.Query.ParamByName('pDataInicial').Value := FormatDateTime('YYYY-MM-DD', StrToDate(AParams.Items['datainicial']))
    Else
       FConexao.Query.ParamByName('pDataInicial').Value := 0;
    ...
    Else
       FConexao.Query.ParamByName('pDataFinal').Value := 0;
    if AParams.ContainsKey('documentonr') then
       FConexao.Query.ParamByName('pDocumentoNr').Value := AParams.Items['docummentonr']
    Else
       FConexao.Query.ParamByName('pDocumentoNr').Value := '';
    if AParams.ContainsKey('codproduto') then
       FConexao.Query.ParamByName('pCodProduto').Value := StrToIntDef(AParams.Items['codproduto'], 0)
    ...
    if AParams.ContainsKey('enderecodestinoid') then
       FConexao.Query.ParamByName('pEnderecoDestinoId').Value := StrToIntDef(AParams.Items['enderecodestinoid'], 0)
    Else
       FConexao.Query.ParamByName('pEnderecoDestinoId').Value := 0;
    if AParams.ContainsKey('tipomovimentacao') then
       FConexao.Query.ParamByName('pTipoMovimentacao').Value := StrToIntDef(AParams.Items['tipomovimentacao'], 0)
    ...
    Else
       FConexao.Query.ParamByName('pUsuarioId').Value := 0;
    if DebugHook <> 0 then
       FConexao.Query.Sql.SaveToFile('ControleArmazenagemSintetico.Sql');
    FConexao.Query.Open;
    if FConexao.Query.IsEmpty then Begin
       Result := TJsonArray.Create;
       Result.AddElement(TJsonObject.Create.AddPair('Erro', 'Não há dados para gerar o relatório'));
...
begin
  try
    FConexao.Query.Sql.Add(TuEvolutConst.SqlGetEstoqueSemMovimentacao);
    if AParams.ContainsKey('codproduto') then
    ...
    if AParams.ContainsKey('periodo') then
       FConexao.Query.ParamByName('pPeriodo').Value := AParams.Items['periodo'].ToInteger
    Else
       FConexao.Query.ParamByName('pPeriodo').Value := 0;
{    if AParams.ContainsKey('enderecoinicial') then
    ...
    Else
       ...
       FConexao.Query.Sql.SaveToFile('EstoqueSemMovimentacao.Sql');
    FConexao.Query.Open;
    if FConexao.Query.IsEmpty then Begin
       Result := TJsonArray.Create;
  ...
  Except ON E: Exception do
    Begin
      raise Exception.Create('Processo: Estoque Sem Picking - ' + StringReplace(E.Message,
...
//    FConexao.Query.Sql.Add('Declare @CausaId    Integer = :pCausaId');
    FConexao.Query.Sql.Add('select ProdutoId, CodigoERP CodProduto, LoteId, DescrLote, Fabricacao, Vencimento, Produto Descricao, Sum(QtdeProducao) QtdeProducao, SUM(Qtde) Saldo');
    ...
    FConexao.Query.Sql.Add('  And (@CodProduto = 0 or CodigoERP = @CodProduto)');
    FConexao.Query.Sql.Add('  And (@ZonaId = 0 or ZonaId = @ZonaId)');
    //FConexao.Query.Sql.Add('  And (@CausaId = 0 or Causadd = @CausaId)');
    FConexao.Query.Sql.Add('Group by ProdutoId, CodigoERP, LoteId, DescrLote, Fabricacao, Vencimento, Produto');
    if AParams.ContainsKey('produtoid') then
       FConexao.Query.ParamByName('pProdutoid').Value := StrToIntDef(AParams.Items['produtoid'], 0)
    Else
       FConexao.Query.ParamByName('pProdutoid').Value := 0;
    if AParams.ContainsKey('codproduto') then
       FConexao.Query.ParamByName('pCodProduto').Value := StrToIntDef(AParams.Items['codproduto'], 0)
...
//       FConexao.Query.ParamByName('pCausaId').Value := 0;
  ...
  Except ON E: Exception do
    Begin
      raise Exception.Create('Processo: Estoque(Endereço por Tipo Detalhes) - ' + StringReplace(E.Message,
            '[FireDAC][Phys][ODBC][Microsoft][SQL Server Native Client 11.0][SQL Server]', '', [rfReplaceAll]));
    End;
  end;
end;
...
begin
  ...
  Except ON E: Exception do
    Begin
      raise Exception.Create('Processo: Estoque(Endereço por Tipo de Estoque) - ' + StringReplace(E.Message,
            '[FireDAC][Phys][ODBC][Microsoft][SQL Server Native Client 11.0][SQL Server]', '', [rfReplaceAll]));
    End;
  end;
end;
...
begin
  try
    ...
    End
    Else
       FConexao.Query.Sql.Add('Order by EET.ProdutoId, Ve.Endereco'); //Parece desnecessário
    End;
...
begin
 ...
 //   if DebugHook <> 0 then
  ...
  Except
    ON E: Exception do
    Begin
      raise Exception.Create('Processo: Estoque(Lote por Tipo de Estoque) - '+TUtil.TratarExcessao(E.Message));
    End;
  end;
end;
...
begin
  ...
  Except ON E: Exception do
    Begin
      raise Exception.Create('Erro: Consulta Kardex - ' + StringReplace(E.Message,
            '[FireDAC][Phys][ODBC][Microsoft][SQL Server Native Client 11.0][SQL Server]', '', [rfReplaceAll]));
    End;
  end;
end;
...
begin
  try
    FConexao.Query.Sql.Add(TuEvolutConst.GetPulmaoTransferencia);
    FConexao.Query.ParamByName('pEnderecoId').Value := pEnderecoId;
    if pEndereco <> '0' then
       FConexao.Query.ParamByName('pEndereco').Value   := pEndereco
    Else
       FConexao.Query.ParamByName('pEndereco').Value   := '';
    if DebugHook <> 0 then
       FConexao.Query.Sql.SaveToFile('GetPulmaoTransferencia.Sql');
    FConexao.Query.Open;
    if FConexao.Query.IsEmpty then Begin
      Result := TJsonArray.Create;
      Result.AddElement(TJsonObject.Create.AddPair('MSG', 'Não há estoque em Pulmão para Transferêcia.'));
    End
    Else If FConexao.Query.FieldByName('QtdeReserva').AsInteger > 0 then Begin
      Result := TJsonArray.Create;
  ...
  Except ON E: Exception do
    Begin
      raise Exception.Create('Processo: GetPulmaoTransferencia(Lote por Tipo de Estoque) - ' + Tutil.TratarExcessao(E.Message));
    End;
  end;
end;
...
begin
  Result := TJsonArray.Create;
  try
    FConexao.Query.Sql.Add(TuEvolutConst.PutPulmaoTransferencia);
    FConexao.Query.ParamByName('pEnderecoIdOrigem').Value  := pEnderecoIdOrigem;
    FConexao.Query.ParamByName('pEnderecoIdDestino').Value := pEnderecoIdDestino;
    if DebugHook <> 0 then
       FConexao.Query.Sql.SaveToFile('GetPulmaoTransferencia.Sql');
...
begin
  ...
  Except ON E: Exception do
    Begin
      raise Exception.Create('Processo: Estoque(Lote por Tipo de Estoque) - ' + StringReplace(E.Message,
            '[FireDAC][Phys][ODBC][Microsoft][SQL Server Native Client 11.0][SQL Server]', '', [rfReplaceAll]));
    End;
  end;
end;
...
begin
  ...
  Except ON E: Exception do
    Begin
      raise Exception.Create('Processo: Estoque(Endereço por Tipo Detalhes) - ' +
        StringReplace(E.Message,
        '[FireDAC][Phys][ODBC][Microsoft][SQL Server Native Client 11.0][SQL Server]',
        '', [rfReplaceAll]));
    End;
...
begin
  ...
  Result := 'Processo: EnderecamentoRuas - ' + StringReplace(Result,
    '[FireDAC][Phys][ODBC][Microsoft][SQL Server Native Client 11.0][SQL Server]',
    '', [rfReplaceAll]);
end;
...
begin
  ...
  Except
    ON E: Exception do
    Begin
      raise Exception.Create('Processo: ValidarMovimentaçãoPallet - ' +
        StringReplace(E.Message,
        '[FireDAC][Phys][ODBC][Microsoft][SQL Server Native Client 11.0][SQL Server]',
        '', [rfReplaceAll]));
    End;
