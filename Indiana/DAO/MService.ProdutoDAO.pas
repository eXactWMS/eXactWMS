...
begin
  ...
  Begin
    Try
      ...
      FConexao.Query.Sql.Add('Declare @LaboratorioId Integer  = (Select IdLaboratorio From Laboratorios Where CodERP = :pLaboratorioId)');
      ...
      FConexao.Query.Sql.Add('End;');
      FConexao.Query.Sql.Add('If Not Exists (Select CodERP From Laboratorios Where IdLaboratorio = @LaboratorioId) Begin');
      FConexao.Query.Sql.Add('   Insert Into Laboratorios (CodERP, Nome, Status, Uuii) Values');
      ...
      FConexao.Query.ParamByName('pUnidadeSigla').Value := pJsonArray.Items[xProd].GetValue<String>('embalagemsigla');
      FConexao.Query.ParamByName('pUnidade').Value := pJsonArray.Items[xProd].GetValue<String>('embalagem');
      FConexao.Query.ParamByName('pUnidadeSecundariaSigla').Value := pJsonArray.Items[xProd].GetValue<String>('embalagemfornecedorsigla');
      FConexao.Query.ParamByName('pUnidadeSecundaria').Value := pJsonArray.Items[xProd].GetValue<String>('embalagemfornecedor');
      FConexao.Query.ParamByName('pFatorConversao').Value := pJsonArray.Items[xProd].GetValue<Integer>('qtdembalagemfornecedor');
      FConexao.Query.ParamByName('pLaboratorioId').Value := pJsonArray.Items[xProd].GetValue<Integer>('fabricanteid');
      ...
      if DebugHook <> 0 then Begin
         FConexao.Query.Sql.Add('--pCodProduto     := ' + pJsonArray.Items[xProd].GetValue<String>('codproduto'));
         FConexao.Query.Sql.Add('--pDescricao      := ' + pJsonArray.Items[xProd].GetValue<String>('descricao'));
         FConexao.Query.Sql.Add('--pUnidade        := ' + pJsonArray.Items[xProd].GetValue<String>('embalagem'));
         FConexao.Query.Sql.Add('--pUnidadeSecundaria := ' + pJsonArray.Items[xProd].GetValue<String>('embalagemfornecedor'));
         FConexao.Query.Sql.Add('--pFatorConversao := ' + pJsonArray.Items[xProd].GetValue<String>('qtdembalagemfornecedor'));
         FConexao.Query.Sql.Add('--pLaboratorioId  := ' + pJsonArray.Items[xProd].GetValue<String>('fabricanteid'));
         FConexao.Query.Sql.Add('--pFabricante     := ' + pJsonArray.Items[xProd].GetValue<String>('fabricante'));
         FConexao.Query.Sql.Add('--pSngpc          := ' + pJsonArray.Items[xProd].GetValue<String>('sngpc'));
         FConexao.Query.Sql.Add('--pCurva          := ' + pJsonArray.Items[xProd].GetValue<String>('curva'));
         FConexao.Query.Sql.Add('--pLiquido        := ' + pJsonArray.Items[xProd].GetValue<String>('liquido'));
         FConexao.Query.Sql.Add('--pInflamavel     := ' + pJsonArray.Items[xProd].GetValue<String>('inflamavel'));
      End;
      if DebugHook <> 0 then
    ...
    Except ON E: Exception do
      Begin
        Result.AddElement(TJsonObject.Create.AddPair('status', '500')
              .AddPair('codproduto', pJsonArray.Items[xProd].GetValue<String>('codproduto')).AddPair('mensagem', E.Message));
      End;
    End;
  End;
end;
