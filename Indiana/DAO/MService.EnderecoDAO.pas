...
type
  ...
  public
    ...
    Function GetLista(pEnderecoId: Integer; pEstruturaId: Integer; pZonaId: Integer; pRuaId: Integer; pEnderecoIni: String;
             pEnderecoFin, pOcupacaoEndereco: String; pStatus: Integer; pBloqueado : Integer; pListaZona: String; pCurva: String; pBuscaParcial : Integer): TjSonArray;
...
function TEnderecoDao.GetLista(pEnderecoId, pEstruturaId, pZonaId: Integer;
  ...
  pStatus: Integer; pBloqueado : Integer; pListaZona: String; pCurva: String; pBuscaParcial : Integer): TjSonArray;
begin
  try
...
//    FConexao.Query.Sql.Add('SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED');
    ...
    FConexao.Query.Sql.Add('Endereco as (select vEnd.enderecoid, vEnd.Endereco descricao, Cast(vEnd.altura as Decimal(15,3)) altura, Cast(vEnd.largura as Decimal(15,3)) largura,');
    FConexao.Query.Sql.Add('                    Cast(vEnd.comprimento as Decimal(15,3)) comprimento, Cast(vEnd.volume as Decimal(15,6)) volume, Cast(vEnd.capacidade as Decimal(15,3)) capacidade,');
    ...
    FConexao.Query.Sql.Add('                    Coalesce(vEnd.descricao, '+#39+#39+') Produto, (Case When vEnd.Curva is Null then '+#39+#39' Else vEnd.Curva End) Curva, 0 as Ocupacao');
    FConexao.Query.Sql.Add('From vEnderecamentos vEnd');
    ...
    FConexao.Query.Sql.Add('');
    FConexao.Query.Sql.Add(',Estoq as (Select Est.EnderecoId, Coalesce(Sum(Qtde), 0) Qtde');
    ...
    FConexao.Query.Sql.Add('		   Group By Est.EnderecoId)');
    FConexao.Query.Sql.Add('');
    FConexao.Query.Sql.Add(',EstPulmao as (Select CodigoERP, Coalesce(Sum(Qtde), 0) Qtde');
    FConexao.Query.Sql.Add('               From vEstoque Est');
    ...
    FConexao.Query.Sql.Add('');
    FConexao.Query.Sql.Add(',EstPicking as (Select Est.EnderecoId, Coalesce(Sum(QtdeProducao), 0) Qtde');
    FConexao.Query.Sql.Add('                From vEstoque Est');
    FConexao.Query.Sql.Add('				Join Endereco TEnd On TEnd.EnderecoId = Est.EnderecoId');
    FConexao.Query.Sql.Add('				Where Est.EstruturaId = 2');
    FConexao.Query.Sql.Add('                Group By Est.EnderecoId)');
    FConexao.Query.Sql.Add(',EstReserva as (Select Est.EnderecoId, Coalesce(Sum(QtdeReserva), 0) Qtde');
    FConexao.Query.Sql.Add('               From vEstoque Est');
    FConexao.Query.Sql.Add('			   Inner join Endereco TEnd On TEnd.EnderecoId = Est.EnderecoId');
    FConexao.Query.Sql.Add('			   Group By Est.EnderecoId)');
    FConexao.Query.Sql.Add('');
    FConexao.Query.Sql.Add(',EstRepo as (Select ET.EnderecoId, Coalesce(Sum(ET.Qtde), 0) Qtde');
    FConexao.Query.Sql.Add('             From ReposicaoEstoqueTransferencia ET');
    FConexao.Query.Sql.Add('			 Join Endereco TEnd On TEnd.EnderecoId = ET.EnderecoId');
    FConexao.Query.Sql.Add('             Where ET.Qtde > 0');
    FConexao.Query.Sql.Add('             Group By ET.EnderecoId)');
    FConexao.Query.Sql.Add(',EstProd as (Select vEst.EnderecoId,');
    ...
    FConexao.Query.Sql.Add('');
    FConexao.Query.Sql.Add(',EstDet as (select Est.Enderecoid, Count(*) Sku,');
    ...
    FConexao.Query.Sql.Add('                   sum(Case when Est.estoqueTipoId Not in (1, 4, 6) then Qtde Else 0 End) QtdeOutros');
    FConexao.Query.Sql.Add('            from Estoque Est');
    FConexao.Query.Sql.Add('			Join Endereco TEnd On TEnd.EnderecoId = Est.EnderecoId');
    FConexao.Query.Sql.Add('            Group by Est.EnderecoId)');
    FConexao.Query.Sql.Add(',BloqInv as (Select II.Enderecoid, COUNT(*) TotalEndereco');
    ...
    FConexao.Query.Sql.Add('		     inner Join vDocumentoEtapas De on De.Documento = I.uuid');
    FConexao.Query.Sql.Add('		     where De.ProcessoId = (Select MAX(ProcessoId) From vDocumentoEtapas Where Documento = I.uuid)');
    FConexao.Query.Sql.Add('		       And De.ProcessoId < 143');
    FConexao.Query.Sql.Add('			 Group by II.EnderecoId)');
    FConexao.Query.Sql.Add('Select (');
    FConexao.Query.Sql.Add('select TEnd.enderecoid, TEnd.descricao, Cast(TEnd.altura as Decimal(15,3)) altura,');
    FConexao.Query.Sql.Add('       Cast(TEnd.largura as Decimal(15,3)) largura, Cast(TEnd.comprimento as Decimal(15,3)) comprimento,');
    FConexao.Query.Sql.Add('       Cast(TEnd.volume as Decimal(15,6)) volume, Cast(TEnd.capacidade as Decimal(15,3)) capacidade,');
    ...
    FConexao.Query.Sql.Add('       IsNull(TEnd.produtoid, 0) as '+#39+'produto.produtoid'+#39+', IsNull(TEnd.codproduto, 0) as '+#39+'produto.codproduto'+#39+',');
...
{    FConexao.Query.Sql.Add('Select (select vEnd.enderecoid,');
    ...
    FConexao.Query.Sql.Add('   Cast(vEnd.volume as Decimal(15,6)) volume,');
    FConexao.Query.Sql.Add('   Cast(vEnd.capacidade as Decimal(15,3)) capacidade,');
    FConexao.Query.Sql.Add('   vEnd.status, vEnd.bloqueado, vEnd.bloqueioinventario, ');
    ...
    FConexao.Query.Sql.Add(' , IsNull(EstDet.QtdeProducao, 0) QtdeProducao, IsNull(EstDet.QtdeReserva, 0) QtdeReserva');
    FConexao.Query.Sql.Add(' , IsNull(EstDet.QtdeOutros, 0) QtdeOutros, IsNull(EstDet.Sku, 0) Sku');
    FConexao.Query.Sql.Add('From vEnderecamentos vEnd');
    ...
    FConexao.Query.Sql.Add('Left Join (select Enderecoid, Count(*) Sku, sum(Case when estoqueTipoId in (1,4) then Qtde Else 0 End) QtdeProducao,');
    FConexao.Query.Sql.Add('                  sum(Case when estoqueTipoId in (6) then Qtde Else 0 End) QtdeReserva,');
    FConexao.Query.Sql.Add('                  sum(Case when estoqueTipoId Not in (1, 4, 6) then Qtde Else 0 End) QtdeOutros');
    FConexao.Query.Sql.Add('           from Estoque');
    FConexao.Query.Sql.Add('           Group by EnderecoId) EstDet On EstDet.EnderecoId = vEnd.EnderecoId');
    ...
    End
    Else Begin
       //Buscar pelo tamanho do endereco enviado
       FConexao.Query.Sql.Add('     (@EnderecoIni = '+#39+#39+' or SubString(vEnd.Endereco, 1, Len(@EnderecoIni))>=@EnderecoIni) and');
